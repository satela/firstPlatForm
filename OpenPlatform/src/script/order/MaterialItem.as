...
//			},null,null);
		...
		private function getCatergoryProduct(callback:Function):void
		{
			...
			HttpRequestUtil.instance.Request(HttpRequestUtil.httpUrl + HttpRequestUtil.getProdListNew + PaintOrderModel.instance.selectAddress.zoneid + "&prodCatName=" + matCategoryVo.matclassname + "&manufacturerCodeList=" + selectoutputCenters.toString() + "&customerCode=" + Userdata.instance.founderPhone+ "&clientCode=" + Userdata.instance.clientCode + "&orderSource=" + PaintOrderModel.instance.orderType,this,function(data:String){
