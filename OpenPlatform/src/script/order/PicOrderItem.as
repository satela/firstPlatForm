...
//				area = 0.1;
			...
			orderitemdata.measureUnit = productVo.getFirstTechMeasureUnit();
			orderitemdata.totalMeasureNum = (productVo.getTotalMeasureNum(finalWidth/100,finalHeight/100) * orderitemdata.itemNumber).toFixed(2);
